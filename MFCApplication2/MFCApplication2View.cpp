...
BEGIN_MESSAGE_MAP(CMFCApplication2View, CView)
	...
	ON_COMMAND(ID_FILE_PRINT, &CMFCApplication2View::showWpfDlg)
...
void CMFCApplication2View::showWpfDlg()
{
    CDomainManagerWrapper* pWrapper = new CDomainManagerWrapper(new CDomainManager);
